...
working_dir = r'D:\Kyushu'

## Main output directory with sub folders
output_dir = r'D:\Kyushu\output'

## Haze removal output folder
haze_dir = r'D:\Kyushu\output\haze_removal'

## Atmospheric correction output folder
atm_dir = r'D:\Kyushu\output\atm_correction'

## Mosaic output folder
mosaic_dir = r'D:\Kyushu\output\mosaic'

## Final Shapefile output folder
final_dir = r'D:\Kyushu\output\mosaic\final'
